<script setup>
// import bootstrap-docs from '/bootstrap-docs.png';
            ...
            <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3">
                <div class="col-lg-6 p-3 p-lg-5 pt-lg-3 mt-3">
                    ...
                    <div class="d-flex gap-2 justify-content-md-start mb-4 mb-lg-3">
                        <button type="button" class="btn btn-dark btn-lg px-4 me-md-2 fw-bold hover-scale">Resume</button>
                        <a class="btn hover-scale" href=""><img src="../assets/linkedIn.svg" style="width: 40px"/></a>
                        <a class="btn hover-scale" href=""><img src="../assets/github.svg" style="width: 40px"/></a>
                        <a class="btn hover-scale" href=""><img src="../assets/leetcodeLight.svg" style="width: 40px"/></a>
                        <!-- <a class="btn hover-scale" href=""><img src="../assets/gmail.svg" style="width: 40px"/></a> -->
                        <a class="btn hover-scale" href=""><img src="../assets/youtube.svg" style="width: 40px"/></a>
                    </div>
